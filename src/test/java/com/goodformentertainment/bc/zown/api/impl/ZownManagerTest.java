...
public class ZownManagerTest extends EasyMockSupport {
    ...
    public void testRenameZown() throws Exception {
        ...
        expect(dataManagerMock.saveZown(eq(worldMock), isA(Tree.class), eq("zown1")))
                .andReturn(true);
        replayAll();
    ...
    public void testResizeZown() throws Exception {
        ...
        assertTrue(zownManager.resizeZown(worldMock, "zown1", new Point(5, 5, 5),
                new Point(10, 10, 10)));
    ...
    public void testSettingTemplate() throws Exception {
        ...
        final Tree<? extends IZown> zown1 = zownManager.createZown(worldMock, "zown1", null,
                new Point(0, 0, 0), new Point(10, 10, 10));
    ...
    public void testMultipleWorldsSameZownName() throws Exception {
        ...
        final Tree<? extends IZown> zown1 = zownManager.createZown(worldMock, "hub", null, null,
                null);
        final Tree<? extends IZown> zown2 = zownManager.createZown(worldMock, "child1", null, null,
                null);

        final Tree<? extends IZown> zown3 = zownManager.createZown(world2Mock, "hub", null, null,
                null);
