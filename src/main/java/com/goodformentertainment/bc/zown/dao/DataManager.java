package com.goodformentertainment.bc.zown.dao;
...
import com.goodformentertainment.bc.zown.ZownPlugin;
import com.goodformentertainment.bc.zown.api.IConfigurable;
...
import com.goodformentertainment.bc.zown.api.impl.Configuration;
import com.goodformentertainment.bc.zown.api.impl.MinecraftMapper;
import com.goodformentertainment.bc.zown.api.impl.Template;
import com.goodformentertainment.bc.zown.api.impl.TemplateManager;
import com.goodformentertainment.bc.zown.api.impl.Zown;
...
public class DataManager {
    ...
    public void loadTemplates(final TemplateManager templateManager) throws DatabaseReadException {
        ...
        for (final DataAccess dataset : datasets) {
            ...
            if (template == null) {
                ...
                ZownPlugin.LOG
                        .warn("Tried to load a duplicate template: " + templateDao.templateName);
            } else {
    ...
    private void loadZowns(final World world, final ITemplateManager templateManager,
        ...
        if (zownDao != null && zownDao.hasData()) {
            ...
            if (zownDao.templateName != null && !zownDao.templateName.equals("null")) {
                ...
                if (template == null) {
                    ZownPlugin.LOG.warn(
                            "The specified template " + zownDao.templateName + " doesn't exist");
                }
            }
    ...
    public boolean saveTemplate(final Template template)
    ...
    public boolean saveZown(final World world, final Tree<Zown> zown)
            throws DatabaseReadException, DatabaseWriteException {
        boolean saved = false;
        if (zown != null) {
    ...
    public boolean removeTemplate(final Template template)
            throws DatabaseReadException, DatabaseWriteException {
    ...
    private void loadConfiguration(final IConfigurable configurable, final AConfigurationDao dao) {
        ...
        if (dao.blockInteractExceptionList != null) {
            for (final String block : dao.blockInteractExceptionList) {
                ...
                if (blockType == null) {
                    ZownPlugin.LOG
                            .warn("Error adding " + block + " to the block interaction exclusions");
                } else {
        ...
        if (dao.entityCreateExceptionList != null) {
            for (final String entity : dao.entityCreateExceptionList) {
                ...
                if (entityClass == null) {
                    ZownPlugin.LOG
                            .warn("Error adding " + entity + " to the entity create exclusions");
                } else {
        ...
        if (dao.entityInteractExceptionList != null) {
            for (final String entity : dao.entityInteractExceptionList) {
                ...
                if (entityClass == null) {
                    ZownPlugin.LOG.warn(
                            "Error adding " + entity + " to the entity interaction exclusions");
                } else {
