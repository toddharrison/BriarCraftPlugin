...
public class ModifyWorldListener implements PluginListener {
    ...
    public void onExplosion(final ExplosionHook hook) {
        ...
        boolean isTnt = false;
        if (cause != null && cause.getEntityType() == EntityType.TNTMINECART
                && cause.getEntityType() == EntityType.TNTPRIMED) {
            isTnt = true;
        }
    ...
    public void onBlockRightClick(final BlockRightClickHook hook) {
        ...
        if (item == null || tileEntity != null || type == BlockType.AcaciaDoor
                ...
                || type == BlockType.Cake || type == BlockType.Cauldron
                || type == BlockType.DarkOakDoor || type == BlockType.DarkOakFenceGate
                || type == BlockType.EndPortalFrame || type == BlockType.Farmland
                || type == BlockType.FenceGate || type == BlockType.Flowerpot
                || type == BlockType.JungleDoor || type == BlockType.JungleFenceGate
                || type == BlockType.Lever || type == BlockType.MobSpawner
                || type == BlockType.OakDoor || type == BlockType.RedstoneRepeaterOff
                || type == BlockType.RedstoneRepeaterOn || type == BlockType.SpruceDoor
                || type == BlockType.SpruceFenceGate || type == BlockType.StoneButton
                || type == BlockType.Trapdoor || type == BlockType.WoodenButton
                || type == BlockType.WoodenDoor) {
