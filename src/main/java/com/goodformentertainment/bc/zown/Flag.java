...
public enum Flag {
    ...
    /**
     * DENY prevents players from leaving a Zown by trying to move outside. If they leave they will
     * be
     * halted.
     */
    playerexit,
    ...
    /**
     * DENY prevents hostile mobs from entering or spawning within a Zown. If they enter they will
     * be
     * removed.
     */
    hostilepermit,
    ...
    /**
     * DENY prevents passive mobs from entering or spawning within a Zown. If they enter they will
     * be
     * halted.
     */
    passivepermit,
